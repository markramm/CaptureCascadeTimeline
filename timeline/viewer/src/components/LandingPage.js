...
const LandingPage = ({ onEnterTimeline }) => {
  ...
  useEffect(() => {
    ...
    const basePath = window.location.hostname === 'markramm.github.io'
      ? '/CaptureCascadeTimeline/api/stats.json'
      : '/api/stats.json';
      ...
      <div className="landing-content">
        ...
        <section className="cta-section">
          ...
          <div className="external-links">
            <a href="https://github.com/markramm/CaptureCascadeTimeline" 
               target="_blank" 
        ...
        <section className="contribute">
          ...
          <div className="contribute-options">
            <div className="contribute-card">
              ...
              <a href="https://github.com/markramm/CaptureCascadeTimeline#validation" 
                 target="_blank" 
                 rel="noopener noreferrer">
                Learn More →
              </a>
            ...
            <div className="contribute-card">
              ...
              <a href="https://github.com/markramm/CaptureCascadeTimeline#contributing" 
                 target="_blank" 
                 rel="noopener noreferrer">
                Contribution Guide →
              </a>
            ...
            <div className="contribute-card">
              ...
              <a href="https://github.com/markramm/CaptureCascadeTimeline/discussions" 
                 target="_blank" 
                 rel="noopener noreferrer">
                Join Discussion →
              </a>
